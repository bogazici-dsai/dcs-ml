...
from hirl.data.serpentine.ai_env import *
...
while episode <= 20:
    ...
    if episode_step > 2000 or fire-lock>20 or fire-lock<0:
        ...
        print("read")
    plot_2d_trajectories(ally_pos, ennemy_pos, save_path=f"expert_data/serpentine/plot/{episode}.png")
...
if if_random: filename = 'expert_data/serpentine/expert_data_ai_random.csv'
else: filename = 'expert_data/serpentine/expert_data_ai.csv'
