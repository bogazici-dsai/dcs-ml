...
@Description: Traffic signal control environment wrapper for Tshub
...
class TSCEnvironment(gym.Env):
    ...
    def reset(self):
        """Reset the simulation environment and return initial observation for this traffic light"""
